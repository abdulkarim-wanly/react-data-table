  ...
  const chromeToolbarEl = useChromeToolbar ? (
    <DataTableToolbar
      classNames={{
        ...
        toolbarFiltersStrip: c.toolbarFiltersStrip,
        toolbarFiltersStripHeader: c.toolbarFiltersStripHeader,
        toolbarFiltersStripTitle: c.toolbarFiltersStripTitle,
        toolbarFiltersStripBody: c.toolbarFiltersStripBody,
        toolbarFiltersStripResetButton: c.toolbarFiltersStripResetButton,
